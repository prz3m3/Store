    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('B', 'Bronze'), ('S', 'Sliver'), ('G', 'Golden')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotion', models.ManyToManyField(related_name='products', to='shop.promotion')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
